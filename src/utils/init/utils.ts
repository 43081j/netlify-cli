...
import { styleText, logAndThrowError, log, type NormalizedCachedConfigConfig, warn } from '../command-helpers.js'
import type { Plugin } from '../types.js'

import { getRecommendPlugins, getUIPlugins } from './plugins.js'

const formatTitle = (title: string) => styleText('cyan', title)
...
export const formatErrorMessage = ({ error, message }) => {
  ...
  return `${message} with error: ${styleText('red', errorMessage)}`
}
