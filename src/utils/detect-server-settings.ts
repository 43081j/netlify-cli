...
import { NETLIFYDEVWARN, styleText, log } from './command-helpers.js'
...
const formatProperty = (str: string) => styleText('magenta', `'${str}'`)
const formatValue = (str: string) => styleText('green', `'${str}'`)
